  ...
  return (
    <>
      <div className={cn("relative")}>
        <AspectRatio ratio={7 / 4.44}>
          <img
            src="/1.jpg"
            alt="HeroImage.png"
            className="object-fill h-[75pc] w-full"
          />
        </AspectRatio>
        <div className="absolute top-0 w-full h-[121vh] bg-black/50"></div>
        <div
          className={cn(
            "absolute transition-all duration-700 left-28 text-white",
        ...
        >
          <div className={cn("my-56 mx-28 flex flex-col gap-14")}>
            ...
            <p className="text-[gray] w-[30pc] text-xl">
              Our architects breathe life into dreams, creating environments
              where innovation meets tradition, and spaces transcend mere
              structures
            </p>
          </div>
        </div>
        ...
        <div
          className={cn(
            "flex flex-col gap-5 absolute top-[55pc] left-56 transition-all duration-700 ",
        ...
        >
          ...
          <ButtonSection Title="View Projects" />
        </div>
      </div>
    </>
  );
