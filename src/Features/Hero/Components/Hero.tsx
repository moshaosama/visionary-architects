  ...
  return (
    <>
      ...
      <div className="absolute top-0 text-white">
        <div className="my-56 mx-28 flex flex-col gap-14">
      ...
      <div className={cn("absolute top-[55pc] flex gap-5 left-28")}>
        <div className="overflow-hidden group hover:rounded-2xl not-hover:rounded-2xl">
          <img
            src="/1.jpg"
            alt="/2.jpg"
            className="w-40 h-40 object-cover rounded-2xl group-hover:scale-150 group-hover:rounded-2xl transition-all duration-300 group-hover:rotate-6"
          />
        </div>
